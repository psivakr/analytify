...
import { getInstanceByDom, connect,BarSeriesOption } from 'echarts';
...
export class EchartsComponent {
  ...
  options4: EChartsOption = {
    ...
    color: ["#00a5a2", "#23b7e5", "#f7b731", "#49b6f5", "#e82646"]
  };
...
randomData(): DataT {
 ...
 makeOption(type: any, symbol: any) :EChartsOption {
  return {
      legend: {
          data: ['2015', '2016'],
          textStyle: {
